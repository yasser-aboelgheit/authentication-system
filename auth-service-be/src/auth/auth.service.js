...
var AuthService = function () {
    ...
    var AuthService = _classThis = /** @class */ (function () {
        function AuthService_1(userModel) {
        ...
        AuthService_1.prototype.generateToken = function (userId) {
            return jwt.sign({ userId: userId }, process.env.JWT_SECRET || 'your-secret-key', { expiresIn: '24h' });
        };
